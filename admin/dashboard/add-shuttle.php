...
<body id="page-top">
                            ...
                            <div class="form-div">
                                ...
                                <form action="" method="POST" class="form">
                                    ...
                                    <div class="form-group">
                                        <label for="">Shuttle Number</label>
                                        <input type="text" name="shuttleno" id="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Number of Seats</label>
                                        <input type="number" name="seats" id="" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="driver" id="" class="form-control">
                                            ...
                                            <?php while($ret = mysqli_fetch_assoc($run)): ?>
                                                <option value="<?php echo $ret['driver_id']; ?>"><?php echo $ret['fullname']; ?></option>
                                            <?php endwhile; ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
    ...
    <script src="../../JS/admin/shuttleAdd.js"></script>
</body>
</html>